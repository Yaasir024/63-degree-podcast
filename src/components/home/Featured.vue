<template>
    <section class="pt-[118px] pb-[85px] px-[28px] xs:px-[42px] md:px-[64px] xl:px-[96px]">
        ...
        <div class="mt-[50px] flex flex-wrap items-center justify-center">
            <div class="card flex-full md:flex-[50%] lg:flex-33.33%">
                <RouterLink to="/episode">
                    <div class=" px-[14px] mb-8 lg:mb-0">
                        <div class="relative overflow-hidden rounded-[7px]">
                            <img src="@/assets/images/podcast/1.png" alt="" class="img">
                            <button
                            ...
                            <button
                                class="absolute bottom-[14px] right-[14px] h-[48px] w-[48px] rounded-full flex items-center justify-center bg-white/10">
                        ...
                        <h3 class="mt-[14px] text-black text-[20px] lg:text-[30px] leading-[28px] lg:leading-[38px] font-semibold">
            ...
            <div class="card flex-full md:flex-[50%] lg:flex-33.33%">
                <RouterLink to="/episode">
                    <div class="px-[14px] mb-8 lg:mb-0">
                        <div class="relative overflow-hidden rounded-[7px]">
                            <img src="@/assets/images/podcast/2.png" alt="" class="img">
